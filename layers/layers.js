...
lyr_OpenStreetMap_0.setVisible(true);lyr_hillshade_wgs21_1.setVisible(true);lyr_zonas_cdmx_2.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_hillshade_wgs21_1,lyr_zonas_cdmx_2];
